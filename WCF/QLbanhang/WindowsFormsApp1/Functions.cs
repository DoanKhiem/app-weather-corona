...
namespace WindowsFormsApp1
{
    internal class Functions
    {
        ...
        public static void Connect()
        {
            ...
            Con.ConnectionString = @"Data Source=KhiemBi\SQLEXPRESS;Initial Catalog=qlbanhang;Integrated Security=True";
            try
            {
                Con.Open();  //Mở kết nối
                             //Kiểm tra kết nối
        ...
        public static bool IsDate(string date)
        {
            ...
            if ((Convert.ToInt32(elements[1]) >= 1) && (Convert.ToInt32(elements[1]) <= 31) && (Convert.ToInt32(elements[0]) >= 1) && (Convert.ToInt32(elements[0]) <= 12) && (Convert.ToInt32(elements[2]) >= 1900))
                return true;
            else return false;
        }
