...
namespace Tungnt.NET.WindowAppForm.MyServiceProxy {
    ...
    [System.ServiceModel.ServiceContractAttribute(ConfigurationName="MyServiceProxy.IWCFServiceDemo")]
    public interface IWCFServiceDemo {
        ...
        Tungnt.NET.WindowAppForm.MyServiceProxy.Student[] GetStudents();
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IWCFServiceDemo/GetStudents", ReplyAction="http://tempuri.org/IWCFServiceDemo/GetStudentsResponse")]
        System.Threading.Tasks.Task<Tungnt.NET.WindowAppForm.MyServiceProxy.Student[]> GetStudentsAsync();
        ...
        bool AddStudent(Tungnt.NET.WindowAppForm.MyServiceProxy.Student newStudent);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IWCFServiceDemo/AddStudent", ReplyAction="http://tempuri.org/IWCFServiceDemo/AddStudentResponse")]
        System.Threading.Tasks.Task<bool> AddStudentAsync(Tungnt.NET.WindowAppForm.MyServiceProxy.Student newStudent);
        ...
        bool UpdateStudent([System.ServiceModel.MessageParameterAttribute(Name="updateStudent")] Tungnt.NET.WindowAppForm.MyServiceProxy.Student updateStudent1);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IWCFServiceDemo/UpdateStudent", ReplyAction="http://tempuri.org/IWCFServiceDemo/UpdateStudentResponse")]
        System.Threading.Tasks.Task<bool> UpdateStudentAsync(Tungnt.NET.WindowAppForm.MyServiceProxy.Student updateStudent);
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IWCFServiceDemoChannel : Tungnt.NET.WindowAppForm.MyServiceProxy.IWCFServiceDemo, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class WCFServiceDemoClient : System.ServiceModel.ClientBase<Tungnt.NET.WindowAppForm.MyServiceProxy.IWCFServiceDemo>, Tungnt.NET.WindowAppForm.MyServiceProxy.IWCFServiceDemo {
        ...
        public Tungnt.NET.WindowAppForm.MyServiceProxy.Student[] GetStudents() {
            return base.Channel.GetStudents();
        }
        
        public System.Threading.Tasks.Task<Tungnt.NET.WindowAppForm.MyServiceProxy.Student[]> GetStudentsAsync() {
            return base.Channel.GetStudentsAsync();
        }
        
        public bool AddStudent(Tungnt.NET.WindowAppForm.MyServiceProxy.Student newStudent) {
            return base.Channel.AddStudent(newStudent);
        }
        
        public System.Threading.Tasks.Task<bool> AddStudentAsync(Tungnt.NET.WindowAppForm.MyServiceProxy.Student newStudent) {
            return base.Channel.AddStudentAsync(newStudent);
        }
        
        public bool UpdateStudent(Tungnt.NET.WindowAppForm.MyServiceProxy.Student updateStudent1) {
            return base.Channel.UpdateStudent(updateStudent1);
        }
        
        public System.Threading.Tasks.Task<bool> UpdateStudentAsync(Tungnt.NET.WindowAppForm.MyServiceProxy.Student updateStudent) {
