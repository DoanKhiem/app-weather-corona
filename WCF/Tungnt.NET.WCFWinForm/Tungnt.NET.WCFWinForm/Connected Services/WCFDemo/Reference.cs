...
namespace Tungnt.NET.WCFWinForm.WCFDemo {
    ...
    public interface IWCFServiceDemo {
        ...
        Tungnt.NET.WCFWinForm.WCFDemo.Student[] GetStudents();
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IWCFServiceDemo/GetStudents", ReplyAction="http://tempuri.org/IWCFServiceDemo/GetStudentsResponse")]
        System.Threading.Tasks.Task<Tungnt.NET.WCFWinForm.WCFDemo.Student[]> GetStudentsAsync();
        ...
        bool AddStudent(Tungnt.NET.WCFWinForm.WCFDemo.Student newStudent);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IWCFServiceDemo/AddStudent", ReplyAction="http://tempuri.org/IWCFServiceDemo/AddStudentResponse")]
        System.Threading.Tasks.Task<bool> AddStudentAsync(Tungnt.NET.WCFWinForm.WCFDemo.Student newStudent);
        ...
        bool UpdateStudent([System.ServiceModel.MessageParameterAttribute(Name="updateStudent")] Tungnt.NET.WCFWinForm.WCFDemo.Student updateStudent1);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IWCFServiceDemo/UpdateStudent", ReplyAction="http://tempuri.org/IWCFServiceDemo/UpdateStudentResponse")]
        System.Threading.Tasks.Task<bool> UpdateStudentAsync(Tungnt.NET.WCFWinForm.WCFDemo.Student updateStudent);
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IWCFServiceDemoChannel : Tungnt.NET.WCFWinForm.WCFDemo.IWCFServiceDemo, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class WCFServiceDemoClient : System.ServiceModel.ClientBase<Tungnt.NET.WCFWinForm.WCFDemo.IWCFServiceDemo>, Tungnt.NET.WCFWinForm.WCFDemo.IWCFServiceDemo {
        ...
        public Tungnt.NET.WCFWinForm.WCFDemo.Student[] GetStudents() {
            return base.Channel.GetStudents();
        }
        
        public System.Threading.Tasks.Task<Tungnt.NET.WCFWinForm.WCFDemo.Student[]> GetStudentsAsync() {
            return base.Channel.GetStudentsAsync();
        }
        
        public bool AddStudent(Tungnt.NET.WCFWinForm.WCFDemo.Student newStudent) {
            return base.Channel.AddStudent(newStudent);
        }
        
        public System.Threading.Tasks.Task<bool> AddStudentAsync(Tungnt.NET.WCFWinForm.WCFDemo.Student newStudent) {
            return base.Channel.AddStudentAsync(newStudent);
        }
        
        public bool UpdateStudent(Tungnt.NET.WCFWinForm.WCFDemo.Student updateStudent1) {
            return base.Channel.UpdateStudent(updateStudent1);
        }
        
        public System.Threading.Tasks.Task<bool> UpdateStudentAsync(Tungnt.NET.WCFWinForm.WCFDemo.Student updateStudent) {
